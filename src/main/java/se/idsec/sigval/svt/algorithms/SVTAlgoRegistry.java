package se.idsec.sigval.svt.algorithms;
...
public class SVTAlgoRegistry {
   ...
   *
   * @param supportedJWSAlgo algorithm
   ...
   *
   * @param supportedJWSAlgo JWS algorithm
   ...
   *
   * @param digestAlgoId Digest algorithm URI identifier
   * @return {@link MessageDigest} instance
   * @throws NoSuchAlgorithmException if specified JWS algorithm is not supported
   */
   ...
   *
   * @param algorithm          The JWSAlgorithm object for this algorithm
   * @param sigAlgoId          XML URI identifier for this algorithm
   * @param digestAlgoId       the XML URI identifier for this algorithm
   * @param digestInstanceName the name of the digest algorithm passed to the supported crypto provider when creating an instance of this hash algorithm
  ...
  public static class AlgoProperties {
    ...
    String digestAlgoId;
    /** The name of the digest algorithm passed to the supported crypto provider when creating an instance of this hash algorithm */
